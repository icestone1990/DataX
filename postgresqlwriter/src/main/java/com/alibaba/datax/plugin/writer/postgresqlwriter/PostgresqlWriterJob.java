...
public class PostgresqlWriterJob extends CommonRdbmsWriter.Job {

	private static final Logger LOG = LoggerFactory.getLogger(PostgresqlWriterJob.class);
	private List<String> tables = null;

	public PostgresqlWriterJob() {
