...
public class GreenplumWriterJob extends CommonRdbmsWriter.Job {

	private static final Logger LOG = LoggerFactory.getLogger(GreenplumWriterJob.class);
	private List<String> tables = null;

	public GreenplumWriterJob() {
