...
public class GreenplumWriterProcessor implements Callable<Long> {
	private static final char FIELD_DELIMITER = '|';
	private static final char NEWLINE = '\n';
	private static final char QUOTE = '"';
	private static final char ESCAPE = '\\';
	private static int MaxCsvSize = 4194304;
	private static final Logger LOG = LoggerFactory.getLogger(GreenplumWriterProcessor.class);

	private int columnNumber;
	private GreenplumWriterTask task;
	...
	public GreenplumWriterProcessor(GreenplumWriterTask task, int columnNumber,
	...
	public Long call() throws Exception {
		Thread.currentThread().setName("GreenplumWriterProcessor");
		Record record = null;
