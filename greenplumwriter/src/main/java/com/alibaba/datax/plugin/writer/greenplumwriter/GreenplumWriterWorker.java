...
public class GreenplumWriterWorker implements Callable<Long> {
	private static int MaxCsvSize = 4194304;
	private static final Logger LOG = LoggerFactory.getLogger(GreenplumWriterWorker.class);

	private GreenplumWriterTask task = null;
	...
	public GreenplumWriterWorker(GreenplumWriterTask task, String copySql, LinkedBlockingQueue<byte[]> queue) throws IOException {
		this.task = task;
	...
	@Override
	public Long call() throws Exception {
		Thread.currentThread().setName("GreenplumWriterWorker");
